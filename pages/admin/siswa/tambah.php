...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$message) {
        ...
        if (mysqli_num_rows($check) > 0) {
            ...
            $stmt = $conn->prepare("INSERT INTO siswa (nama_siswa, nis, jenis_kelamin, tanggal_lahir, alamat, foto, id_kelas) VALUES (?, ?, ?, ?, ?, ?, ?)");
            $stmt->bind_param("ssssssi", $nama_siswa, $nis, $jenis_kelamin, $tanggal_lahir, $alamat, $foto, $id_kelas);
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="text-center mb-8 animate-slide-up">
                ...
                <p class="text-gray-600 dark:text-gray-300 text-lg">
                    Lengkapi data siswa dengan teliti
                </p>
